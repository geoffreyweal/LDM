...
commands = [
    ('run','LDM.interface.run'),
]

def main(prog='LDM', description='LDM command line tool.',version=__version__, commands=commands, hook=None, args=None):
